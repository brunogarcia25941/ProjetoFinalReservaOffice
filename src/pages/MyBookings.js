...
function MyBookings() {
  ...
  // --- BUSCAR AS RESERVAS (useEffect) ---
  // Este hook corre automaticamente quando a página "As Minhas Reservas" é aberta
  useEffect(() => {
  ...
  const cancelarReserva = async (id) => {
    ...
    try {
      // Pedido DELETE para cancelar a reserva específica
